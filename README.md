...
## Conclusion
The analysis shows that home prices in Buenos Aires are influenced by both property size and neighborhood location. While larger homes generally command higher prices, location plays a significant role in determining property value across different areas. Through data cleaning, visualization, and correlation analysis, clear patterns emerged showing how price and size relationships vary between neighborhoods. Overall, the project demonstrates how data analysis can uncover meaningful real estate trends and support evidence-based insights into urban housing markets.
